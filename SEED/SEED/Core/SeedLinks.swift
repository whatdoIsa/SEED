...
/// SEED 전용 문서(/seed/privacy·/seed/terms)를 가리킨다 — AI 튜터·구독 조항이 실린 완성본.
/// (회사 공통 /ko/* 문서에는 앱 조항이 없다 — 게시·검증 2026.7.18)
enum SeedLinks {
    /// 개인정보처리방침 — App Store Connect 앱 정보에도 같은 URL 입력
    static let privacyPolicy = URL(string: "https://www.arcseed.kr/seed/privacy")!
    /// 이용약관 (EULA) — 구독 페이월 필수 링크
    static let terms = URL(string: "https://www.arcseed.kr/seed/terms")!
